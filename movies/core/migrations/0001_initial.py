    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='covers/movies/')),
                ('trailer_url', models.URLField(blank=True, null=True)),
                ('video_type', models.CharField(choices=[('UPLOAD', 'File Upload'), ('URL', 'External URL')], default='URL', max_length=10)),
                ('video_file', models.FileField(blank=True, null=True, upload_to='videos/movies/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255)),
                ('slug', models.SlugField(blank=True, max_length=255, unique=True)),
                ('type', models.CharField(choices=[('TV_SHOW', 'TV Show'), ('ANIME', 'Anime')], default='TV_SHOW', max_length=20)),
                ('description', models.TextField(blank=True, null=True)),
                ('release_date', models.DateField(blank=True, null=True)),
                ('rating', models.DecimalField(decimal_places=1, default=0.0, max_digits=3)),
                ('views', models.PositiveIntegerField(default=0)),
                ('poster', models.ImageField(blank=True, null=True, upload_to='posters/series/')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='covers/series/')),
                ('trailer_url', models.URLField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('genres', models.ManyToManyField(related_name='series', to='core.genre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('views', models.PositiveIntegerField(default=0)),
                ('video_type', models.CharField(choices=[('UPLOAD', 'File Upload'), ('URL', 'External URL')], default='URL', max_length=10)),
                ('video_file', models.FileField(blank=True, null=True, upload_to='videos/episodes/')),
                ('external_video_url', models.URLField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
